...
class SimilarityResult(BaseModel):
    """A return schema for the similarity service"""
    score:          float
    product_name:   str
...
async def product_similarity_threshold_svc(
    ...
    Future: (Delete when done)
    - Need to pass in an identifiable id
    - Could maybe have higher subscriptions can use more compute searching more products
    """
